...
% dynare estimation_rotembergversion_us.mod
...
estimation(datafile='us_obs_file_2.csv',            % Specify the data file
           mode_compute=6,              % Specify the optimizer (e.g., 6 for CMA-ES, or 4 for Chris Sims' optimizer)
           mh_replic=100000,             % Number of MH draws (set to 0 if you don’t want to run MH yet)
