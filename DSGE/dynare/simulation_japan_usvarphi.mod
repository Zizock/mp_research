...
% dynare simulation_japan_usvarphi.mod

% This mod simulates estimated Japan model with varphi value from US estimation.
...
stoch_simul(periods=2000,irf=12,order=1) Y C N H L W R ii infl;
